...
try {
    ...
    # Note: .csproj files are not included in NuGet packages by design
    # Package metadata is handled by the .nuspec file generated by dotnet pack
    Write-Host "  ℹ️  Package metadata handled by .nuspec (generated by dotnet pack)" -ForegroundColor Cyan
    $TotalChecks++
    $PassedChecks++
